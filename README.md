...
فایل [`.github/workflows/daily-post.yml`](.github/workflows/daily-post.yml) هر ساعت (سر ساعت)
به‌صورت خودکار `python main.py` را روی گیت‌هاب اجرا می‌کند (هم اپیزود جدید چک می‌شود، هم یک اپیزود
از آرشیو) — یعنی آرشیو قدیمی هم حالا هر ساعت یک اپیزود، نه روزی یک اپیزود، پردازش می‌شود.
